...
@Component({
  selector: 'codx-list-step',
  templateUrl: './codx-list-step.component.html',
  styleUrls: ['./codx-list-step.component.scss'],
})
export class CodxListStepComponent implements OnInit, AfterViewInit, OnChanges {
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    if (changes?.dataCM) {
      ...
      }else if(this.entityName == 'DP_Instances'){
