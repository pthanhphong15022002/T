...
@Component({
  ...
  templateUrl: './issue-transactions-line-add.component.html',
  styleUrls: ['./issue-transactions-line-add.component.css']
})
export class IssueTransactionsLineAddComponent extends UIComponent implements OnInit{
