    ...
    this.api
      ...
      .subscribe((res: any) => {
        if (res) {
          ...
          this.imageGroup
            .updateFileDirectReload(this.groupId)
            .subscribe((res2) => {
              if (res2) {
                console.log(res2);
              }
