...
import { ChartAllModule, ChartTheme } from '@syncfusion/ej2-angular-charts';
import { CircularGaugeModule, GaugeTheme, ILoadedEventArgs } from '@syncfusion/ej2-angular-circulargauge';
