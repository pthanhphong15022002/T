...
@Component({
  selector: 'hr-table-newemployee',
  templateUrl: './hr-table-newemployee.component.html',
  styleUrls: ['./hr-table-newemployee.component.scss']
})
export class HrTableNewemployeeComponent extends UIComponent{
