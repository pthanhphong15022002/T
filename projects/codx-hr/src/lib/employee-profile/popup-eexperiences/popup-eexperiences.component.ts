...
export class PopupEexperiencesComponent extends UIComponent implements OnInit {
  ...
  constructor(
    ...
    if(this.actionType === 'edit' || this.actionType === 'copy'){
      this.data = JSON.parse(JSON.stringify(this.lstExperience[this.indexSelected]))
    ...
    if(this.actionType === 'add' || this.actionType === 'copy'){
      ...
      this.hrService.UpdateEmployeeExperienceInfo(this.formModel.currentData).subscribe(p => {
        if(p != null){
          ...
          if(this.listView){
            (this.listView.dataService as CRUDService).update(this.lstExperience[this.indexSelected]).subscribe()
          }
