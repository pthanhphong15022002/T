...
export class EmployeeProfileComponent extends UIComponent {
  ...
  className = 'EExperiencesBusiness_Old';
  ...
  onInit(): void {
    ...
    this.routeActive.queryParams.subscribe((params) => {
      if (params.employeeID || this.user.userID) {
        ...
        (opPassport.page = 1),
          this.api
            .execSv('HR', 'Core', 'DataBusiness', 'LoadDataAsync', opPassport)
            .subscribe((res) => {
              ...
              (op2.page = 1),
                this.api
                  .execSv('HR', 'Core', 'DataBusiness', 'LoadDataAsync', op2)
                  .subscribe((res) => {
  ...
  UpdateEBenefitPredicate() {
    ...
    if (
      ...
      (this.grid.dataService as CRUDService).setPredicates(
        [this.filterEBenefitPredicates],
