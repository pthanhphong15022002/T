...
import { ViewBasicSalaryDetailComponent } from 'projects/codx-hr/src/lib/employee-basic-salary/view-basic-salary-detail/view-basic-salary-detail.component';
...
@Component({
  selector: 'lib-dialog-waiting-leaving-approve',
  templateUrl: './dialog-waiting-leaving-approve.component.html',
  styleUrls: ['./dialog-waiting-leaving-approve.component.scss'],
  providers:[CodxCoreModule]
})
export class DialogWaitingLeavingApproveComponent extends UIComponent {

 //#region view
 @ViewChild('templateList') templateList?: TemplateRef<any>;
 @ViewChild('headerTemplate') headerTemplate?: TemplateRef<any>;
 @ViewChild('aaaaa') aaaaa?: TemplateRef<any>;
 ...
 GetGvSetup() {
   ...
   this.cache.functionList(funID).subscribe((fuc) => {
    console.log("check formName", fuc )
     this.cache
