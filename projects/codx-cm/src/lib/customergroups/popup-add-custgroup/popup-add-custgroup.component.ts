...
@Component({
  selector: 'lib-popup-add-custgroup',
  templateUrl: './popup-add-custgroup.component.html',
  styleUrls: ['./popup-add-custgroup.component.css'],
})
export class PopupAddCustgroupComponent implements OnInit, AfterViewInit {
  dialog: any;
  data: any;
  headerText = '';
  action: any;
  ...
  constructor(
    ...
    this.gridViewSetup = data?.data?.gridViewSetup;
  }
