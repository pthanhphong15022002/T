...
import { UIComponent, ViewModel, ButtonModel, FormModel, ResourceModel, CacheService, NotificationsService, ViewType, SidebarModel, RequestOption } from 'codx-core';
...
export class LeadsComponent  extends UIComponent
