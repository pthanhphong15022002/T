...
import { BookingAttendees } from '../codx-booking.model';


@Component({
  selector: 'codx-invite-room-attendees',
  templateUrl: './codx-invite-room-attendees.component.html',
  styleUrls: ['./codx-invite-room-attendees.component.css'],
})
export class CodxInviteRoomAttendeesComponent implements OnInit {
