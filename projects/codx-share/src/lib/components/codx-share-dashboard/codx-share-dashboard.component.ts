...
@Component({
  selector: 'lib-codx-share-dashboard',
  templateUrl: './codx-share-dashboard.component.html',
  styleUrls: ['./codx-share-dashboard.component.scss']
})

export class CodxShareDashboardComponent extends WSUIComponent{
  listModule:any;
  listDashboard = [];
  listDashboards = [];
  listBookMarks=[];
