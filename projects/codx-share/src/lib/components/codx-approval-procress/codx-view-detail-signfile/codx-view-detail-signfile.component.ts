...
@Component({
  ...
  templateUrl: './codx-view-detail-signfile.component.html',
  styleUrls: ['./codx-view-detail-signfile.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class CodxViewDetailSignFileComponent extends UIDetailComponent implements OnInit {
  runMode: any;
  constructor(
    inject: Injector,
