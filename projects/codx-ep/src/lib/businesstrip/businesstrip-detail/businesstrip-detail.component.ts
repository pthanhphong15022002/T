...
@Component({
  selector: 'ep-businesstrip-detail',
  templateUrl: './businesstrip-detail.component.html',
  styleUrls: ['./businesstrip-detail.component.css']
})
export class BusinesstripDetailComponent extends UIDetailComponent implements AfterViewInit, OnChanges, OnDestroy {
