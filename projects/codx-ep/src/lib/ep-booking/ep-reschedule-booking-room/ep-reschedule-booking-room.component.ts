...
@Component({
  selector: 'ep-reschedule-booking-room',
  templateUrl: './ep-reschedule-booking-room.component.html',
  styleUrls: ['./ep-reschedule-booking-room.component.css'],
})
export class EpRescheduleBookingRoomComponent
  extends UIComponent
  implements OnInit
{
