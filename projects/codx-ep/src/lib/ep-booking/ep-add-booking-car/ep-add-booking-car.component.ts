...
import { Device, Equipments } from '../../models/equipments.model';
...
@Component({
  selector: 'ep-add-booking-car',
  templateUrl: './ep-add-booking-car.component.html',
  styleUrls: ['./ep-add-booking-car.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class EpAddBookingCarComponent
  extends UIComponent
  implements AfterViewInit
{
  ...
  driverChangeWithCar(carID: string) {
    ...
    this.codxEpService.getGetDriverByCar(carID).subscribe((res: any) => {
