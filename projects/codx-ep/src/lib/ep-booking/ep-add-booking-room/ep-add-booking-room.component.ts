...
@Component({
  selector: 'ep-add-booking-room',
  templateUrl: './ep-add-booking-room.component.html',
  styleUrls: ['./ep-add-booking-room.component.scss'],
})
export class EpAddBookingRoomComponent extends UIComponent {
  ...
  getCacheData() {
    ...
    this.codxShareService
      .getSettingValueWithOption('F', _EPParameters)
      .subscribe((sv: any) => {
        if (sv) {
          let roomSetting_1 = this.codxEpService.getCacheSettingValue(
            sv,
            _EPRoomParameters,
            '1'
          );
          ...
          let roomSetting_4 = this.codxEpService.getCacheSettingValue(
            sv,
            null,
            '4',
          ...
          let staSetting_1 = this.codxEpService.getCacheSettingValue(
            sv,
          ...
          let staSetting_4 = this.codxEpService.getCacheSettingValue(
            sv,
            null,
            '4',
  ...
  checkOnlineUrlAndCapacity(approval: boolean) {
    ...
    if (
      ...
      this.notificationsService.alertCode('EP012').subscribe((x) => {
        if (x.event?.status == 'Y') {
          if (
            this.attendeesNumber > this.roomCapacity &&
