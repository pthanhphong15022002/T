...
@Component({
  selector: 'ep-booking-view-detail',
  templateUrl: 'ep-booking-view-detail.component.html',
  styleUrls: ['ep-booking-view-detail.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class EpBookingViewDetailComponent
  extends UIComponent
