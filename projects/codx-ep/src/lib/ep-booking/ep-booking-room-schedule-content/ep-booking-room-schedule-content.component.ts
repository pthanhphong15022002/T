...
@Component({
  selector: 'ep-booking-room-schedule-content',
  templateUrl: 'ep-booking-room-schedule-content.component.html',
  styleUrls: ['ep-booking-room-schedule-content.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class EpBookingRoomScheduleContentComponent
  extends UIComponent
