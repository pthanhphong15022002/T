...
export class AdvanceComponent extends UIComponent implements AfterViewInit,OnDestroy {
  ...
  add(){
    ...
    .subscribe((data:any) => {
      if(data)
      {
        ...
        let popup = this.callfc.openSide(PopupAddAdvanceComponent,obj,dialog,this.view.funcID);
