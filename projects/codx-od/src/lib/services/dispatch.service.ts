...
// 
   ...
   countDispatchByDate(date:Date)
   {
    ...
    getDetailDispatch(recID:any , objectType:any , referType:any , isEntities=false , funcID:any = "")
    {
       return this.api.exec<any>('OD', 'DispatchesBusiness', 'GetItemByIDAsync', [recID,objectType , referType,isEntities,funcID]);
    }
