...
import { AuthStore, CacheService, DataRequest, DialogData, DialogRef, NotificationsService, ViewsComponent } from 'codx-core';
...
export class SendEmailComponent implements OnInit{
  ...
  onSave(e:any)
  {
   ...
   this.dataAssign.recID = this.data.recID;
    ...
    this.sendEmailForm.value.saveTemplate = this.sendEmailForm.value.saveTemplate == null ? false :this.sendEmailForm.value.saveTemplate;
    this.odService.sendMail(this.dialog.dataService.dataSelected.recID, this.sendEmailForm.value).subscribe((item)=>
    {
