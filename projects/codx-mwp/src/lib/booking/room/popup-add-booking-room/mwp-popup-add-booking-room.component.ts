...
@Component({
  selector: 'mwp-popup-add-booking-room',
  templateUrl: './mwp-popup-add-booking-room.component.html',
  styleUrls: ['./mwp-popup-add-booking-room.component.scss'],
})
export class MWPPopupAddBookingRoomComponent extends UIComponent {
