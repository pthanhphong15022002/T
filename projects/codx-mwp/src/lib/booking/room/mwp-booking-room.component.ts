...
@Component({
  ...
  templateUrl: './mwp-booking-room.component.html',
  styleUrls: ['./mwp-booking-room.component.scss'],
})
export class MWPBookingRoomComponent extends UIComponent implements AfterViewInit {
