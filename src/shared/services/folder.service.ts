...
export class FolderService implements OnDestroy {
  ...
  getFoldersByFunctionID(funncID: string): Observable<any> {
    ...
    var data = this.api.exec<FolderInfo[]>(
      'DM',
      'FolderBussiness',
      'GetFoldersByFunctionIdAsync',
      [funncID]
  ...
  renameFolder(id: string, folderName: string): Observable<any> {
    return this.api.exec<DataReturn>(
      'DM',
      'FolderBussiness',
      'ReplaceFolderNameAsync',
      [id, folderName]
    );
  }
  ...
  copyFolder(
    ...
    return this.api.exec<DataReturn>(
      ...
      'FolderBussiness',
      'CopyFolderAsync',
      [id, fullName, id_to, move, rewrite]
    );
  }
  ...
  updateFolderCache(
    ...
    return this.api.exec<DataReturn>(
      'DM',
      'FolderBussiness',
      'UpdateFolderCacheAsync',
      [folderId, moduleId, folderPath, folderID]
    );
  }
  ...
  UpdateRequestAsync(
    ...
    return this.api.execSv<DataReturn>(
      'DM',
      'DM',
      'FolderBussiness',
      'UpdateRequestAsync',
      [id, objectID, status, isActive]
    );
  }
