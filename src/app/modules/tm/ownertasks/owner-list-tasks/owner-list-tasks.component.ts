...
@Component({
  selector: 'owner-list-tasks',
  templateUrl: './owner-list-tasks.component.html',
  styleUrls: ['./owner-list-tasks.component.scss']
})
export class OwnerListTasksComponent implements OnInit, AfterViewInit {
  @Input() data = [];
  ...
  confirmDelete(e: any, t: OwnerListTasksComponent) {
