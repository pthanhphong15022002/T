...
declare var _;
@Component({
  selector: 'assign-list-tasks',
  templateUrl: './assign-list-tasks.component.html',
  styleUrls: ['./assign-list-tasks.component.scss']
})
export class AssignListTasksComponent implements OnInit {
  ...
  confirmDelete(e: any, t: AssignListTasksComponent) {
