...
import { CardSettingsModel, DialogSettingsModel, SwimlaneSettingsModel } from '@syncfusion/ej2-angular-kanban';
import { AuthStore, CacheService, CallFuncService, CoDxKanbanComponent, CodxListviewComponent, NotificationsService } from 'codx-core';
import { ViewBaseComponent } from 'codx-core/lib/layout/views/view-base/view-base.component';

@Component({
  selector: 'app-sprints-task-kanban',
  templateUrl: './sprints-task-kanban.component.html',
  styleUrls: ['./sprints-task-kanban.component.scss']
})
export class SprintsTaskKanbanComponent implements OnInit {
  ...
  constructor(
    ...
    this.router.firstChild?.params.subscribe(
