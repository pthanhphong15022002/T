...
import { LoginQTSCComponent } from './login-qtsc.component';
...
const fakeRoutes: Routes = [
  { path: 'auth/login', component: LoginQTSCComponent },
...
describe('LoginQTSCComponent', () => {
  let component: LoginQTSCComponent;
  let fixture: ComponentFixture<LoginQTSCComponent>;
  let injector;
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [LoginQTSCComponent],
      providers: [
        {
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(LoginQTSCComponent);
